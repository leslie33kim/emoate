...
def convert_rbk(img, style):
    if style == "HAYAO":
        # =./static/images tempfile.gettempdir()
        img = Image.open(img)
        img = img.convert('RGB')
        ...
        src1 = cv2.imread("./static/images/2.png", cv2.IMREAD_UNCHANGED)  #배경 없앤 사진 
        src = cv2.imread("./static/images/1.png", cv2.IMREAD_COLOR)        #그림으로 바꾼 사진 
        ...
        i = "./static/images/3.png" #마스크
        cv2.imwrite(i, mask1)

        j = "./static/images/4.png" #마스크 픽셀 복사 
    ...
    if style == "SHINKAI":
        ...
        img = ImageOps.exif_transpose(img)
        img.save("./static/images/0.png")
        result_image = "./static/images/1.png"
        cmd_rembg = "cat " + "./static/images/0.png"  + " | python3 ./remvbk.py > " + result_image
        os.system(cmd_rembg)
